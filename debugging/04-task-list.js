...
`delete todos[0]` deletes the element at index 0 but does not shift the other
elements over by 1 index. Therefore there is a missing slot, resulting in a
sparse array. Repeatedly deleting a missing slot doesn't do anything.
